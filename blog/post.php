...
$bc_post = new BreadcrumbBlog(
    [
        "Blog" => '/blog',
        ucfirst($post->category) => '/blog/index.php?cat=' . Post::cat_name_format($post->category)
    ],
    $title
);
...
<?php else : ?>
    <div class="pb-3">
        ...
        <div>
            ...
            <?php if ($isset_author) : ?>
                <hr>
                <div class="card bg-light mt-5" style="max-width: 30rem;">
                    <!-- author box -->
